...
export interface OptionsUnicorn {
  /**
   * Include all rules recommended by `eslint-plugin-unicorn`, instead of only ones picked by Anatoly.
   *
   * @default false
   */
...
export interface OptionsConfig extends OptionsComponentExts, OptionsProjectType {
  ...
  /**
   * Disable some opinionated rules to Anatoly's preference.
   *
   * Including:
   * - `achesnokov/top-level-function`
   * - `achesnokov/if-newline`
   *
   * @default false
   */
