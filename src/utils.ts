...
const isCwdInScope = isPackageExists('@anatolychesnokov/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@anatolychesnokov/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@anatolychesnokov/eslint-config'
