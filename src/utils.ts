...
const isCwdInScope = isPackageExists('@achesnokov/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@achesnokov/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@achesnokov/eslint-config'
