...
export async function formatters(
  ...
  const configs: TypedFlatConfigItem[] = [
    {
      name: 'achesnokov/formatter/setup',
      plugins: {
        format: pluginFormat,
      },
    },
  ...
  if (options.css) {
    configs.push(
      ...
      },
      {
        ...
        name: 'achesnokov/formatter/scss',
        rules: {
          'format/prettier': [
            'error',
            mergePrettierOptions(prettierOptions, {
      ...
      },
      {
        ...
        name: 'achesnokov/formatter/less',
        rules: {
          'format/prettier': [
            'error',
            mergePrettierOptions(prettierOptions, {
  ...
  if (options.html) {
    configs.push({
      ...
      name: 'achesnokov/formatter/html',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
  ...
  if (options.markdown) {
    ...
    configs.push({
      ...
      name: 'achesnokov/formatter/markdown',
      rules: {
        [`format/${formater}`]: [
          'error',
          formater === 'prettier'
    ...
    if (options.slidev) {
      configs.push({
        ...
        name: 'achesnokov/formatter/slidev',
        rules: {
          'format/prettier': [
            'error',
            mergePrettierOptions(prettierOptions, {
  ...
  if (options.astro) {
    configs.push({
      ...
      name: 'achesnokov/formatter/astro',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
    ...
    configs.push({
      ...
      name: 'achesnokov/formatter/astro/disables',
      rules: {
  ...
  if (options.graphql) {
    configs.push({
      ...
      name: 'achesnokov/formatter/graphql',
      rules: {
        'format/prettier': [
          'error',
          mergePrettierOptions(prettierOptions, {
