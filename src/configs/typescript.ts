...
export async function typescript(
  ...
  function makeParser(typeAware: boolean, files: string[], ignores?: string[]): TypedFlatConfigItem {
    return {
      ...
      name: `achesnokov/typescript/${typeAware ? 'type-aware-parser' : 'parser'}`,
    }
  }
  ...
  return [
    {
      ...
      name: 'achesnokov/typescript/setup',
      plugins: {
    ...
    {
      files,
      name: 'achesnokov/typescript/rules',
      rules: {
        ...renameRules(
    ...
    ...isTypeAware
      ? [{
          ...
          name: 'achesnokov/typescript/rules-type-aware',
          rules: {
            ...typeAwareRules,
            ...overridesTypeAware,
          },
